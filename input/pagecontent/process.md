...
#### Data recipients
#### Data flow
Describe the end-2-end data flow. Identify the requirement of multi-stage de-identification.
### Data assessment
#### Data content
What data must be retained in order to satisfy the primary and tertiary needs of the project?
##### Data subject
What legal sensitivities apply to these data? Are the data subject to special sensitivity rules such as for behavioral health?
##### Data type
##### Data attribute type
##### Dataset properties

#### Attack modeling
What are the threats that need to be protected against?
...
- What is the acceptable level of privacy risk (for example, a tumor board will accept a high level of risk than a clinical trial)?
- Is there a need to re-identify the original patient? What elements are needed for this purpose?
- What general types of entities are being de-identified? Patients? Providers? Facilities? Other?
- What are the additional project requirements beyond raw data, for example administrative tracking data?
- Is there a need to maintain clinical time threading? Does it maintain a time relationship to external events? If so, what is the type of error allowed (e.g., time shifted, fuzzy, loss of precision)?
...
- How accurate do the remaining data elements need to be? Is it desirable for the remaining data to not show evidence of de-identification?
