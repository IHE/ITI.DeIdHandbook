...
Table above is an illustration of a reversible-pseudonymized dataset generated via applying the process of [Stage 1: Transforming Identified Data into Reversible-Pseudonymized Data](#stage-1-transforming-identified-data-into-reversible-pseudonymized-data) to the sample data specified in the Table: Identified Patient Records.
